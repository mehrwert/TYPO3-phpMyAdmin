...
$scripts->addFile('pma-vendor/jquery/jquery.tablesorter.js');
$scripts->addFile('pma-vendor/jquery/jquery.sortableTable.js');
// for charting
$scripts->addFile('pma-vendor/jqplot/jquery.jqplot.js');
$scripts->addFile('pma-vendor/jqplot/plugins/jqplot.pieRenderer.js');
$scripts->addFile('pma-vendor/jqplot/plugins/jqplot.enhancedPieLegendRenderer.js');
$scripts->addFile('pma-vendor/jqplot/plugins/jqplot.canvasTextRenderer.js');
$scripts->addFile('pma-vendor/jqplot/plugins/jqplot.canvasAxisLabelRenderer.js');
$scripts->addFile('pma-vendor/jqplot/plugins/jqplot.dateAxisRenderer.js');
$scripts->addFile('pma-vendor/jqplot/plugins/jqplot.highlighter.js');
$scripts->addFile('pma-vendor/jqplot/plugins/jqplot.cursor.js');
