 ...
 *
 * @requires    jquery
 * @requires    pma-vendor/jquery/jquery.svg.js
 * @requires    pma-vendor/jquery/jquery.mousewheel.js
 * @requires    pma-vendor/jquery/jquery.event.drag-2.2.js
 */
...
function initGISVisualization () {
    ...
    if (typeof OpenLayers !== 'undefined') {
        ...
        OpenLayers._getScriptLocation = function () {
            return './js/pma-vendor/openlayers/';
        };
        // Adds necessary styles to the div that coontains the openStreetMap
        styleOSM();
