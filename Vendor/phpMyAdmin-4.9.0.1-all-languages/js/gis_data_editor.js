...
function loadJSAndGISEditor (value, field, type, input_name) {
    ...
    var smallScripts = ['js/pma-vendor/jquery/jquery.svg.js',
        'js/pma-vendor/jquery/jquery.mousewheel.js',
        'js/pma-vendor/jquery/jquery.event.drag-2.2.js',
    ...
    script.src = 'js/pma-vendor/openlayers/OpenLayers.js';
    head.appendChild(script);
