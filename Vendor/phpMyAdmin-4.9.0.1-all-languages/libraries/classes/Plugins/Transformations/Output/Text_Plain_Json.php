    ...
    public function __construct()
    {
        if (!empty($GLOBALS['cfg']['CodemirrorEnable'])) {
            ...
            $scripts = $response->getHeader()
                ->getScripts();
            $scripts->addFile('pma-vendor/codemirror/lib/codemirror.js');
            $scripts->addFile('pma-vendor/codemirror/mode/javascript/javascript.js');
            $scripts->addFile('pma-vendor/codemirror/addon/runmode/runmode.js');
