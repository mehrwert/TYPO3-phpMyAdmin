...
class Header
{
    ...
    {
        // Localised strings
        $this->_scripts->addFile('pma-vendor/jquery/jquery.min.js');
        $this->_scripts->addFile('pma-vendor/jquery/jquery-migrate.js');
        $this->_scripts->addFile('whitelist.php');
        $this->_scripts->addFile('pma-vendor/sprintf.js');
        $this->_scripts->addFile('ajax.js');
        $this->_scripts->addFile('keyhandler.js');
        $this->_scripts->addFile('pma-vendor/jquery/jquery-ui.min.js');
        $this->_scripts->addFile('pma-vendor/js.cookie.js');
        $this->_scripts->addFile('pma-vendor/jquery/jquery.mousewheel.js');
        $this->_scripts->addFile('pma-vendor/jquery/jquery.event.drag-2.2.js');
        $this->_scripts->addFile('pma-vendor/jquery/jquery.validate.js');
        $this->_scripts->addFile('pma-vendor/jquery/jquery-ui-timepicker-addon.js');
        $this->_scripts->addFile('pma-vendor/jquery/jquery.ba-hashchange-1.3.js');
        $this->_scripts->addFile('pma-vendor/jquery/jquery.debounce-1.0.5.js');
        ...
        if ($GLOBALS['cfg']['SendErrorReports'] !== 'never') {
            $this->_scripts->addFile('pma-vendor/tracekit.js');
        ...
        if (! $this->_headerIsSent) {
            if (! $this->_isAjax && $this->_isEnabled) {
                ...
                if ($GLOBALS['cfg']['CodemirrorEnable']) {
                    $this->_scripts->addFile('pma-vendor/codemirror/lib/codemirror.js');
                    $this->_scripts->addFile('pma-vendor/codemirror/mode/sql/sql.js');
                    $this->_scripts->addFile('pma-vendor/codemirror/addon/runmode/runmode.js');
                    $this->_scripts->addFile('pma-vendor/codemirror/addon/hint/show-hint.js');
                    $this->_scripts->addFile('pma-vendor/codemirror/addon/hint/sql-hint.js');
                    if ($GLOBALS['cfg']['LintEnable']) {
                        $this->_scripts->addFile('pma-vendor/codemirror/addon/lint/lint.js');
    ...
    private function _getLinkTags()
    {
        ...
        if ($this->_isPrintView) {
            ...
            $retval .= '<link rel="stylesheet" type="text/css" href="'
                . $basedir . 'js/pma-vendor/codemirror/lib/codemirror.css?' . $v . '" />';
            $retval .= '<link rel="stylesheet" type="text/css" href="'
                . $basedir . 'js/pma-vendor/codemirror/addon/hint/show-hint.css?' . $v . '" />';
            $retval .= '<link rel="stylesheet" type="text/css" href="'
                . $basedir . 'js/pma-vendor/codemirror/addon/lint/lint.css?' . $v . '" />';
            $retval .= '<link rel="stylesheet" type="text/css" href="'
