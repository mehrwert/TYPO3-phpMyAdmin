...
if (isset($_COOKIE[$session_name])) {
	...
	$extensionConfiguration['PMA_typo_socket'] = $_SESSION['PMA_typo_socket'];
...
if (isset($extensionConfiguration['PMA_typo_socket'])) {
	$cfg['Servers'][$i]['connect_type'] = 'socket';
	$cfg['Servers'][$i]['socket'] = $extensionConfiguration['PMA_typo_socket'];
} else {
